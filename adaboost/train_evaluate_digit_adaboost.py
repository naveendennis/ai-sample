...
if __name__ == '__main__':
    ...
    clf = AdaBoostClassifier(n_estimators=1000,
                             algorithm='SAMME.R',
                             base_estimator=DecisionTreeClassifier(criterion='entropy', min_samples_split=5))
    ...
    # """
    #
    # for estimator_size in range(1000,10000,1000):
    #
    #     from sklearn.ensemble import AdaBoostClassifier
    #     train_features = np.array([[]])
    #     clf = AdaBoostClassifier(n_estimators=estimator_size, algorithm='SAMME.R', base_estimator=None)
    #     clf.fit(feature_train, label_train)
    #
